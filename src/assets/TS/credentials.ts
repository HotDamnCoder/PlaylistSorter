...
export { YOUTUBE_CLIENT_ID, YOUTUBE_SCOPE, YOUTUBE_DISCOVERY_DOCS, SPOTIFY_CLIENT_SECRET, SPOTIFY_CLIENT_ID, SPOTIFY_REDIRECT_URI, SPOTIFY_SCOPE, SPOTIFY_ERROR_RE, SPOTIFY_AUTH_TOKEN_RE }
